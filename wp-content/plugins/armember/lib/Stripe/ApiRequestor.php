...
class ApiRequestor
{
    ...
    public function handleApiError($rbody, $rcode, $rheaders, $resp)
    {
        ...
        switch ($rcode) {
            ...
            case 404:
                throw new Error\Stripe_InvalidRequest($msg, $param, $rcode, $rbody, $resp, $rheaders);
            case 401:
                throw new Error\Stripe_Authentication($msg, $rcode, $rbody, $resp, $rheaders);
            case 402:
                throw new Error\Stripe_Card($msg, $param, $code, $rcode, $rbody, $resp, $rheaders);
            case 403:
    ...
    private function _requestRaw($method, $url, $params, $headers)
    {
        ...
        if (!$myApiKey) {
            ...
            throw new Error\Stripe_Authentication($msg);
        }
