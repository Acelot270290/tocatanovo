...
<div class="error">
	<p><strong><?php esc_html_e( 'WooCommerce PagSeguro', 'woocommerce-pagseguro-assinaturas' ); ?></strong> <?php esc_html_e( 'depends on the last version of Extra Checkout Fields for Brazil to work!', 'woocommerce-pagseguro-assinaturas' ); ?></p>
	...
	?>
		<p><a href="<?php echo esc_url( $url ); ?>" class="button button-primary"><?php esc_html_e( 'Install Extra Checkout Fields for Brazil', 'woocommerce-pagseguro-assinaturas' ); ?></a></p>
	<?php endif; ?>
</div>
