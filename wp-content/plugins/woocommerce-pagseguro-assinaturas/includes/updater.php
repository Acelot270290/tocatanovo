...
/* Load Class. */
$wc_pagseguro_assinaturas_updater = new WC_PagSeguro_Assinaturas_Updater();

/**
 * Updater Class
**/
class WC_PagSeguro_Assinaturas_Updater{
	...
	public function __construct() {
		...
		/* Updater Config */
		$this->config = array(
			'server'  => 'https://wcpagsegurorecorrente.com.br/',
			'type'    => 'plugin',
			'id'      => 'woocommerce-pagseguro-assinaturas/woocommerce-pagseguro-assinaturas.php',
			'api'     => '1.0.0',
			'post'    => array(),
		);
